...
3. In the services/ui-src directory copy the .env_example file and name it .env. NOTE: Once copied, remove the comment `#pragma allowlist secret` from the file
