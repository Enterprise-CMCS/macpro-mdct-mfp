import { EntityShape, OverlayModalStepTypes, ReportRoute } from "types";
import { convertToThousandsSeparatedString } from "utils";

/**
 * Routes with entitySteps are deprecated as of Report Year 2026, Period 2.
 * These utils are for backward compatibility.
 */
