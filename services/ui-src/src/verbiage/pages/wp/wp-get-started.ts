export default {
  intro: {
    header: "Before you begin the WP online form",
  },
  body: {
    sections: [
      {
        ...
        body: "You will need to submit one WP for every managed care program in your state. For this WP report, a managed care program is defined by distinct benefits and eligibility criteria articulated in a contract between states and the state’s managed care plans.",
        widget: {
      ...
      },
      {
        ...
        body: "The online form sections are organized by state-level, program-level, plan-level indicators. In general, the WP online form matches the organization of the WP Excel workbook. There are some exceptions.",
        img: {
          alt: "Image of side navigation in the application ",
          description: "Preview of the online WP form navigation.",
        },
        ...
        table: {
          headRow: ["Excel Workbook Tab", "Location in WP online form"],
          bodyRows: [
      ...
      {
        sectionNumber: 3,
        header: "Submit the WP report to CMS",
        body: "Double check that everything in your WP Report is accurate. You will be able to make edits if necessary and resubmit. Once you are ready, hit Review & Submit.",
        img: {
