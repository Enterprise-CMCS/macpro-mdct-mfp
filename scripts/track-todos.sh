...
EXCLUSIONS="--exclude-dir=.build --exclude-dir=.git --exclude-dir=coverage --exclude-dir=node_modules --exclude=track-todos.sh --exclude=*.log --exclude-dir=./build_dev --exclude-dir=./services/ui-src/build"
